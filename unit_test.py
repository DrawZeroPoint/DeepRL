...
#
# tensorboard = ti.TensorboardInterface('/home/omnisky/', 'sss')
#
# for i in range(10):
#     tensorboard.add_scalar('loss', i, i)
#
# tensorboard.export()
# file_name = 'a' + ".json"
# print(file_name)
...
# import glob
# f_list = glob.glob("/home/omnisky/CartPole-v0*")
# s = "/home/omnisky/CartPole-v0"
# print(len(s))
# print(f_list)
